      ...
      <ClientOnly>
        ...
        >
          <div flex flex-row flex-wrap items-center justify-center gap-4 px-4 pt-4 sm-px-0>
            ...
            />
            <a-button
              danger type="primary" size="large"
            ...
            <div class="ml-auto h-40px flex items-center">
              <dark-toggle v-if="!printPreview" mr-2 />
              <a-switch v-model:checked="printPreview">
...
html.dark .select.ant-select-disabled * {
